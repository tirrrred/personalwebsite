    ...
    <b-container fluid class="row-background-cover intro">
      <b-container class="info-block">
        ...
        <b-container class="text-block">
          ...
          <br><br>
          <p class="small"><span class="contrast-blue">psst:</span> <a href="#" rel="noopener noreferrer">Here is the TL;DR version for the lazy people (like me)</a></p>
        </b-container>
      </b-container>
    </b-container>
    <b-container fluid class="row-background-cover pre-education">
      <b-container class="info-block">
        ...
        <b-container class="text-block">
          ...
          but nothing could compare with the interest in <span class="contrast-blue">football</span>. All the time used to play football ensured an active, healthy, social boy, 
